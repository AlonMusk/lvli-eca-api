 ...
 */
    ...
    'pay' => [
        'default' => [
            ...
            'private_key'        =>  env('WECHAT_PAYMENT_KEY_PATH','/data/private/certs/apiclient_key.pem'),
            'certificate'        => env('WECHAT_PAYMENT_CERT_PATH','/data/private/certs/apiclient_cert.pem'),
            ...
            //  ],
             ...
             // v3 API 秘钥
             'secret_key' =>env('WECHAT_PAYMENT_KEY', 'key-for-signature'),
    
             // 注意 此处为微信支付平台证书 https://pay.weixin.qq.com/wiki/doc/apiv3/apis/wechatpay5_1.shtml
             'platform_certs' => [
                env('WECHAT_PAYMENT_KEY_PATH','/data/private/certs/platform_key.pem'),
             ],
        ],
    ],
