...
class VolumeUnitController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $query = VolumeUnit::orderBy('created_at', 'desc');
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $model = VolumeUnit::find($request->id);
            if(!$model){
    ...
    {
        $dealResult = VolumeUnit::find($request->id);
        $outFormat = $dealResult;
        return resp($outFormat);
    }
}
