...
use App\Models\NumUnit;
use App\Models\Sku;

class NumUnitController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $query = NumUnit::orderBy('created_at', 'desc');
    ...
    public function add(Request $request)
    {
        if (!empty($validatedData = ApiValidator::validate($request->all(), [
            'name' => 'required|unique:li_volume_unit',
    ...
    {
        $dealResult = NumUnit::find($request->id);
        $outFormat = $dealResult;
        return resp($outFormat);
    }
    ...
    public function del(Request $request)
    {
        ...
        try {
            ...
            $model = Sku::where(['num_unit' => $request->id])->first();
            if ($model) {
