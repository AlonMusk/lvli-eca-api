...
use App\Models\ActSpu;

class ActSpuController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        $query = ActSpu::orderBy('created_at', 'desc');
    ...
    {
        $dealResult = ActSpu::find($request->id);
        $outFormat = $dealResult;
        return resp($outFormat);
    }
}
